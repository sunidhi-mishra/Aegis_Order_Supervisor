...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI-powered order operations dashboard — timeline, review queue, LLM inspector, analytics, and audit trail." },
      { name: "author", content: "Sagepilot" },
      { property: "og:title", content: "Sagepilot Order Supervisor" },
      { property: "og:description", content: "AI-powered order operations dashboard — timeline, review queue, LLM inspector, analytics, and audit trail." },
